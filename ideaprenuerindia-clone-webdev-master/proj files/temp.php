...
echo '<div class="hii"><p><h1 class="title">'.$row["title"].'</h1>
          	<img class="rounded mx-auto d-block img-fluid" alt="Responsive image" src='.$row["img"].'>
            <h4>
...
<style type="text/css">
  ...
  <div class="container commentbox">
    ...
    <div class="col-md-5">
      <input type="hidden" value="<?php echo $_SESSION["username"]?>" class="name form-control" placeholder="Name"><br>
      <textarea class="comment form-control" placeholder="Comment"></textarea>
      <!-- <p>&nbsp;</p> --><br>
      <?php
      if(isset($_SESSION["username"]))
      {
        echo '<a href="javascript:void(0)" class="btn btn-dark submit">Submit</a>';
      }
      else {
        echo '<a href="register.php">Register </a>to comment<br>';
        echo 'if you have a account <a href="loginu.php">login</a>';
      }
